PROTODIR = ./src/protos
FRONTPROTOSTUBSDIR = ./src/protos/protostubs/
...
protoc-gen-back: createprotofiles
	python -m grpc_tools.protoc -I=$(PROTODIR) $(PROTODIR)/*.proto --python_out=$(BACKPROTOSTUBSDIR) --grpc_python_out=$(BACKPROTOSTUBSDIR)
